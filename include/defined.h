...
#define STD_LOCATION 0.01 ///the standart deviation of the location in the monte carlo
#define STD_SPIN 0.2 ///the standart deviation of the orientation in the monte carlo
//can't be zero!

//L > D
#define D_0 0.3 /// the small size of the liquid crystal molecule.
#define L_0 1.0 /// the long size of the liquid crystal molecule
